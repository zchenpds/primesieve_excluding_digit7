...
uint64_t numPrimeWithSeven = 0; /// by Zhuo
...
/// by Zhuo
/// Count the primes with 7 in its decimal format
///
void PrimeFinder::countPrimesWithSeven(const byte_t* sieve, uint_t sieveSize) const
{
...
{
    countPrimesWithSeven(sieve, sieveSize); /// by Zhuo
  if (ps_.isCallback())
